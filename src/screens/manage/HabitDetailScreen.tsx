            ...
            <View style={styles.modalCard}>
              ...
              <HintText>
                {lockedDayCount !== null
                  ...
                  : "These are your check-in days — when you'll be reminded. You can log on any day and it still counts toward your weekly quota. To prevent quota dodging, day changes (including which days you're reminded on) only take effect from next week onward."}
              </HintText>
